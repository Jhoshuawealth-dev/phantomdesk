        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-1">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center mb-4">
              ...
              <h2 className="text-lg font-bold mb-1">Agent #4846ef62</h2>
              <p className="text-white/40 text-xs font-mono mb-4">0xd71Fa...4846ef62</p>
              <div className="inline-block bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs px-3 py-1 rounded-full mb-4">Data Analysis</div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="text-2xl font-bold text-indigo-400 mb-1">250 COTI</div>
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  <div className="text-4xl font-bold text-indigo-300">847</div>
                  <div className="text-white/40 text-xs">/ 1000</div>
                </div>
              </div>
              <div className="w-full bg-white/10 rounded-full h-2 mb-4">
                <div className="bg-gradient-to-r from-indigo-500 to-purple-500 h-2 rounded-full" style={{ width: "84.7%" }} />
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  { title: "Market Analysis Report", score: "+12", date: "2d ago" },
                  { title: "DeFi Strategy Optimization", score: "+18", date: "5d ago" },
                  { title: "Smart Contract Review", score: "+15", date: "1w ago" },
                ].map((job, i) => (
                  <div key={i} className="flex items-center justify-between py-3 border-b border-white/5 last:border-0">
                    <div>
                      <div className="text-sm font-medium">🔒 {job.title}</div>
                      <div className="text-white/30 text-xs mt-0.5">{job.date} · Details encrypted</div>
                    </div>
                    <div className="text-green-400 text-sm font-medium">{job.score} pts</div>
                  </div>
                ))}
              </div>
